...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un medallista");
	...
	{
		System.out.println("\n" + "Conocer el pais de un atleta" + "\n");

		String atleta = input("Ingrese el nombre del atleta: ");
		Atleta data = null;
		data = calculadora.buscarAtleta(atleta);
		if (data == null)
		{
		...
		{
			Pais x = data.darPais();
			System.out.println("El pais del atletla proporcionado es: "+ x.darNombre());
		}
	}
